...
int main(){
               ...
               initializeGame(numPlayers,k, seed, &state);
                ...
                cardEffect(smithy, choice_1, choice_2, choice_3,&state,handPos, &bonus);




                printf("\n The player_0 gains 3 cards\n");
                assertTrueFunction(state.handCount[player_0],stateOriginal.handCount[player_0] + 2);
    			...
    			assertTrueFunction(state.handCount[player_1],stateOriginal.handCount[player_1]);
    			
    			printf("Deck Count\n");
    			
    			assertTrueFunction(state.deckCount[player_1],stateOriginal.deckCount[player_1]);
